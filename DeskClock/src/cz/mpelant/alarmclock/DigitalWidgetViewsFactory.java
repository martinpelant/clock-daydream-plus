...
import cz.mpelant.deskclock.Alarms;
import cz.mpelant.deskclock.Utils;
import cz.mpelant.deskclock.worldclock.CityObj;
import cz.mpelant.deskclock.worldclock.WorldClockAdapter;
...
public class DigitalWidgetViewsFactory extends BroadcastReceiver implements RemoteViewsFactory {
    ...
    public void onCreate() {
        ...
        filter.addAction("cz.mpelant.deskclock.NEXT_ALARM_TIME_SET");
        filter.addAction("cz.mpelant.deskclock.worldclock.update");
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals("cz.mpelant.deskclock.NEXT_ALARM_TIME_SET")) {
        ...
        } else if (action.equals("cz.mpelant.deskclock.worldclock.update")) {

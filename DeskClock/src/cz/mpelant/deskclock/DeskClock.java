...
import cz.mpelant.deskclock.stopwatch.StopwatchFragment;
import cz.mpelant.deskclock.stopwatch.StopwatchService;
import cz.mpelant.deskclock.stopwatch.Stopwatches;
import cz.mpelant.deskclock.timer.TimerFragment;
import cz.mpelant.deskclock.timer.TimerObj;
import cz.mpelant.deskclock.timer.Timers;
import cz.mpelant.deskclock.worldclock.CitiesActivity;
...
public class DeskClock extends Activity implements LabelDialogFragment.TimerLabelDialogHandler {
    ...
    private class TabsAdapter extends FragmentPagerAdapter implements ActionBar.TabListener, ViewPager.OnPageChangeListener {
        ...
        public Fragment getItem(int position) {
            ...
            DeskClockFragment f = (DeskClockFragment) Fragment.instantiate(mContext, info.clss.getName(), info.args);
            return f;
        }
        ...
        public boolean onTouch(View v, MotionEvent e) {
            switch (e.getAction()) {
                ...
                case (MotionEvent.ACTION_UP):
                    ...
                    if (xDiff < MAX_MOVEMENT_ALLOWED && yDiff < MAX_MOVEMENT_ALLOWED && timeDiff < MAX_TIME_ALLOWED) {
                        if (mMakePressedTextView != null) {
